...
const readStatusToggle = (e) => {
  ...
  // Get book id
  const indexSwitch =
    event.target.parentNode.parentNode.parentNode.parentNode.parentNode.dataset
      .id;

  // Changes text, alignment and checked attribute
  if (myLibrary[indexSwitch].readStatus === true) {
    event.target.parentElement.parentElement.firstChild.nextSibling.textContent =
      "Not Read";
